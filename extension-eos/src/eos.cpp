...
namespace extEOS
{
    ...
    if (!extEOS::InitAchievements(g_PlatformHandle))
    {
    ...
    if (!extEOS::InitStats(g_PlatformHandle))
    {
...
DM_DECLARE_EXTENSION(EXTENSION_NAME, LIB_NAME, 0, 0, ExtEOS_Initialize, ExtEOS_Update, 0, ExtEOS_Finalize)
